...
//        if useAuth, let refreshToken = Self.auth.refreshToken {
//            if Self.auth.requiresRefresh {
//                let oauth = try await Self.auth.getToken(with: refreshToken)
//                Self.auth.storage = oauth
//                
//                headers["Authorization"] = "Bearer \(oauth.accessToken)"
//            } else if let token = Self.auth.accessToken {
//                headers["Authorization"] = "Bearer \(token)"
//            } else {
//                print("[PointercrateAPIConfig] Couldn't authenticate request for \(apiURL.absoluteString)")
//            }
//        } else {
